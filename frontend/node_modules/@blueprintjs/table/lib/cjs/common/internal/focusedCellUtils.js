...
exports.expandFocusedRegion = exports.toFullCoordinates = exports.isFocusedCellAtRegionRight = exports.isFocusedCellAtRegionLeft = exports.isFocusedCellAtRegionBottom = exports.isFocusedCellAtRegionTop = exports.getInitialFocusedCell = exports.getFocusedOrLastSelectedIndex = void 0;
...
function getInitialFocusedCell(enableFocusedCell, focusedCellFromProps, focusedCellFromState, selectedRegions) {
    if (!enableFocusedCell) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, regions_1.Regions.getFocusCellCoordinatesFromRegion(selectedRegions[lastIndex])), { focusSelectionIndex: lastIndex });
    }
    else {
...
function toFullCoordinates(cellCoords, focusSelectionIndex) {
    ...
    return tslib_1.__assign(tslib_1.__assign({}, cellCoords), { focusSelectionIndex: focusSelectionIndex });
}
